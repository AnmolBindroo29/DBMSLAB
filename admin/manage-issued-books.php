...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="update-issue-bookdetails.php?rid=<?php echo htmlentities($result->rid);?>&ISBNNumber=<?php echo htmlentities($result->ISBNNumber);?>&status=<?php echo htmlentities($str);?>&days=<?php echo htmlentities($days);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
