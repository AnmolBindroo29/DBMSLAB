...
{               ?>                         
                                        <tr class="odd gradeX">										    
											...
											<td class="center"><a href="issue-book2.php?BookID=<?php echo $result->BookID;?>&StudentID=<?php echo $result->StudentID;?>"><i class="fa fa-edit "></i></a> Issue&nbsp;&nbsp;</td>
                                        </tr>
<?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
                                </table>
